...
$trackingCode = $_POST['trackingCode']; // Corrected variable name
...
if ($updateResult) {
        if ($newStatus === 'Ready to Pick Up') {
            ...
            $stmt = "SELECT email FROM certificates WHERE tracking_code=?";
            ...
            if ($selectResult->num_rows > 0) {
                ...
                $mail->Body = 'Your Indigency Certificate document is now ready for pickup. Please visit our office to collect it.';
