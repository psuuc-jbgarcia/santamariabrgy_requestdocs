$(function(){
    ...
    function loadClearance() {
        $("#business-permit-tab").load('fetch_clearancerequest.php');
    }
    
    function loadIndigency() {
        $("#business-permit-tab").load('fetch_indigencyrequest.php');
    }
    
    function loadResidency() {
        $("#business-permit-tab").load('fetch_residencyrequest.php');
    }
