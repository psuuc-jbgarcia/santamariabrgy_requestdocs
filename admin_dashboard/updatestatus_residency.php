...
if ($updateResult) {
        if ($newStatus === 'Ready to Pick Up') {
            ...
            $stmt = "SELECT email FROM residency WHERE tracking_code=?";
            ...
            if ($selectResult->num_rows > 0) {
                ...
                $mail->Body = 'Your Residency Certificate document is now ready for pickup. Please visit our office to collect it.';
