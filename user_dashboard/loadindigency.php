...
if(isset($_SESSION['user'])) {
    ...
    $stmt = "SELECT * FROM certificates WHERE username=? order by id desc";
    ...
    if($certificateData->num_rows > 0) {
        ...
        while($row = $certificateData->fetch_assoc()) {
            ...
            // echo '<td><button class="btn btn-danger cancel-btn" data-toggle="modal" data-target="#cancelIndigencyModal">Cancel Request</button>
            // </td>';
