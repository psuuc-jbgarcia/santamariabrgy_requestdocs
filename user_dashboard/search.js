...
$.get("track_business_document.php?tid="+trackingId,function(data,status){
...
function trackClearanceDocument(trackingId) {
    $.get("track_clearance_document.php?tid="+trackingId ,function(data,status) {
...
$.get("track_indigency_document.php?tid="+trackingId,function(data,status){
    $("#tracking-info").html(data);
    ...
    function trackResidencyDocument(trackingId) {
        ...
        $.get("track_residency_document.php?tid="+trackingId,function(data,status){
            $("#tracking-info").html(data);
