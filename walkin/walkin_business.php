...
<body>
 ...
 $id=$_GET['id'];
 $sql = "SELECT CONCAT(firstName, ' ', middleName, ' ', lastName) AS full_name, purpose, brgy,submissionDate,businessName,businessNature FROM walkinrequests WHERE id = '$id'";
    ...
    ?>
            <form id="permit-form">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="businessName" required  value="<?php echo $data['businessName'] ?>">
                </div>
                <div class="form-group">
                    <label for="businessType" class="theme-color">Type of Business:</label>
                    <input type="text" class="form-control" id="businessType" required  value="<?php echo $data['businessNature'] ?>">
                </div>
                <div class="form-group">
                    <label for="ownerName" class="theme-color">Owner's Name:</label>
                    <input type="text" class="form-control" id="ownerName" required value="<?php echo $data['full_name'] ?>">
                </div>
                <div class="form-group">
                    <label for="startDate" class="theme-color">Start Date:</label>
                    <input type="datetime-local" class="form-control" id="startDate" required value="<?php echo $data['submissionDate'] ?>">
                </div>
                <?php 
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="endDate" required value="<?php echo $expiryDate ?>">
                </div>
