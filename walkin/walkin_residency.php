...
while($data=$result->fetch_assoc()){
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="barangayName" required value="<?php echo is_array($data['brgy']) ? '' : $data['brgy'] ?>">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="datetime-local" class="form-control" id="issueDate" required value="<?php echo $data['submissionDate'] ?>">
    </div>
    <div class="form-group">
    <?php
       $issueDate = $data['submissionDate']; // Assuming the issued date is stored in 'date_requested' column
