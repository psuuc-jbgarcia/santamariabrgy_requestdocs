    ...
    ?>
            <form id="indigency-form">  
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="address" required  value="<?php echo $data['brgy'] ?>" >
                </div>
                <div class="form-group">
                    <label for="purpose" class="theme-color">Purpose:</label>
                    <textarea class="form-control" id="purpose" rows="3" required><?php echo $data['purpose'] ?></textarea>
                </div>
                <div class="form-group">
                    <label for="issueDate" class="theme-color">Date Issued:</label>
                    <input type="text" class="form-control" id="issueDate" required  value="<?php echo $data['submissionDate'] ?>">
                </div>
                <?php 
